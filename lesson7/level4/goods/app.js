...
let myProducts = document.body.querySelector(".products");
let myElms = document.body.querySelectorAll('button');
myElms.forEach(el => el.addEventListener("click",clickHandler));
...
function showCategory(category) {
    ...
    products[category].forEach(el => {
        ...
        product.innerHTML = `<div>${el.name}</div>
            ...
            <div>${el.price}</div>
            <a href="https://example.com/producs/${el.id}">Подробнее</a>`;
